...
void JPEGImageIO2::SetMemoryBuffer(const char * inputBuffer, size_t sizeInBytes )
{
  this->m_Buffer = inputBuffer;
  this->m_BufferSize = sizeInBytes;
  this->m_ImageDataSource = SOURCE_IS_MEMORY;
  this->Modified();
}

bool JPEGImageIO2::CanReadFile(const char *file)
{
  ...
  switch( this->ImageDataSource )
    ...
    case SOURCE_IS_MEMORY:
      {
      jpeg_memory_src(&cinfo, this->m_Buffer, this->m_BufferSize );
      break;
      }
    }
...
void JPEGImageIO2::ReadVolume(void *)
{}

//-----------------------------------------------------------------------------

void JPEGImageIO2::Read(void *buffer)
{
  unsigned int ui;
  ...
  if ( !fp )
    {
    itkExceptionMacro( "Error JPEGImageIO2 could not open file: "
                       << this->GetFileName()
                       << std::endl
                       << "Reason: "
...
void JPEGImageIO2::PrintSelf(std::ostream & os, Indent indent) const
{
...
void JPEGImageIO2::ReadImageInformation()
{
...
bool JPEGImageIO2::CanWriteFile(const char *name)
{
...
void JPEGImageIO2::WriteImageInformation(void)
{}

void JPEGImageIO2::Write(const void *buffer)
{
...
void JPEGImageIO2::WriteSlice(std::string & fileName, const void *buffer)
{
