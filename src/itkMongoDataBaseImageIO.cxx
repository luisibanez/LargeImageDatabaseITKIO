...
MongoDataBaseImageIO::MongoDataBaseImageIO()
{
}
...
void MongoDataBaseImageIO::PrintSelf(std::ostream& os, Indent indent) const
{
  Superclass::PrintSelf(os, indent);
}

bool MongoDataBaseImageIO::CanReadFile( const char* filename )
{
  // FIXME Implement
  return true;
}
...
void MongoDataBaseImageIO::ReadImageInformation()
{
...
void MongoDataBaseImageIO::Read( void * buffer)
{
...
bool MongoDataBaseImageIO::CanWriteFile( const char * name )
{
  //
  // MongoDataBase is not implemented to write yet.
  // It will be soon...
  //
  return false;
}
